...
public class LocationDAOImp {
    public ArrayList<String> top3Luoghi()throws SQLException {
        ...
        String sql=" SELECT location_name, photo_count FROM photogallery.location ORDER BY photo_count DESC";
...
public Location aggLocationPhoto(String location_name,Double x_coordinates,Double y_coordinates,Integer photo_count) throws SQLException{
    Connection connection = DatabaseConnection.getInstance().getConnection();
